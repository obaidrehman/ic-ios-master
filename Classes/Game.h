...
@property (nonatomic, strong) NSString *whiteEngine;
@property (nonatomic, strong) NSString *blackEngine;
@property (nonatomic, strong) NSString *eloWhite;
@property (nonatomic, strong) NSString *eloBlack;
