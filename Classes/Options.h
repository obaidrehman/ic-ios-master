...
enum GameMode {
   ...
   GAME_MODE_TWO_PLAYER,
    // adding new game modes for online gameplay
    GAME_MODE_KIBITZ,       // use this for kibitzing purpose
    GAME_MODE_ONLINE_BLACK, // use this if playing online as black
    GAME_MODE_ONLINE_WHITE, // use this if playing online as white
};
