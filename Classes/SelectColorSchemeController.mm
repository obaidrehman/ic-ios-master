...
- (void)viewDidLoad{
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor colorWithRed:40.0/255.0 green:40.0/255.0 blue:40.0/255.0 alpha:1.0]; //setBackgroundColor:[UIColor blackColor]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
   ...
   if (cell == nil) {
      ...
      [smallLabel setText: name];
       [smallLabel setTextColor:UIColor.whiteColor];
   ...
   if ([[[cell textLabel] text] isEqualToString: [[Options sharedOptions]
      ...
      [cell setAccessoryType: UITableViewCellAccessoryCheckmark];
       [[MyManager sharedManager] setBoardColor:[[[tableView cellForRowAtIndexPath: indexPath] textLabel] text]];
      checkedRow = row;
   }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   if (row != checkedRow) {
      [[Options sharedOptions] setValue: [[[tableView cellForRowAtIndexPath: indexPath] textLabel] text] forKey: @"colorScheme"];
       [[NSUserDefaults standardUserDefaults] setObject:[[[tableView cellForRowAtIndexPath: indexPath] textLabel] text] forKey:@"boardTheme"];
      ...
      checkedRow = row;
      //[gameoptionsViewController updateTableCells];
   }
